...
public interface SalesSettlementDetailRepository extends JpaRepository<SalesSettlementDetailViewEntity, Object> {
	...
	@Query(nativeQuery = true, value = "select "
			+ "(select ("
			+ "(select NVL(sum(p.payment_total),0) as sales_total from paymentinfo p, roominfo rm where p.room_no=rm.room_no and p.payment_state='T' and sales_state='F' and (((rm.room_type='desk') or (rm.room_type like 'meeting%')) and p.backoffice_no=?1  and trunc(payment_date)=trunc(current_date))) + "
			...
			+ "(select NVL(sum(payment_total),0) as sales_total from paymentinfo p, roominfo rm where p.room_no=rm.room_no and rm.room_type='office' and p.backoffice_no=?1 and payment_state='T' and sales_state='F' and trunc(payment_date)=trunc(current_date)) ) sales_total from dual) as sales_total, "
			...
			+ "(select ("
			+ "(select NVL(sum(p.payment_total),0) as sales_total from paymentinfo p left outer join roominfo rm on p.room_no=rm.room_no where p.payment_state='T' and sales_state='F' and (((rm.room_type='desk') or (rm.room_type like 'meeting%')) and p.backoffice_no=?1 and trunc(payment_date)=trunc(current_date)-1) ) + "
			...
			+ "(select NVL(sum(payment_total),0) as sales_total from paymentinfo p left outer join roominfo rm on p.room_no=rm.room_no where rm.room_type='office' and p.backoffice_no=?1 and payment_state='T' and sales_state='F' and trunc(payment_date)=trunc(current_date)-1 ) ) pre_sales_total from dual) as pre_sales_total, "
	...
	@Query(nativeQuery = true, value = "select  "
			+ "(select ( "
			+ "(select NVL(sum(p.payment_total),0) as sales_total from paymentinfo p, roominfo rm where p.room_no=rm.room_no and p.payment_state='T' and sales_state='F' and (((rm.room_type='desk') or (rm.room_type like 'meeting%')) and p.backoffice_no=?1  and trunc(payment_date) between trunc(current_date) - interval '7' day and trunc(current_date) )) +  "
			...
			+ "(select NVL(sum(payment_total),0) as sales_total from paymentinfo p, roominfo rm where p.room_no=rm.room_no and rm.room_type='office' and p.backoffice_no=?1 and payment_state='T' and sales_state='F' and trunc(payment_date) between trunc(current_date) - interval '7' day and trunc(current_date)) ) sales_total from dual) as sales_total,  "
			...
			+ "(select ( "
			+ "(select NVL(sum(p.payment_total),0) as sales_total from paymentinfo p left outer join roominfo rm on p.room_no=rm.room_no where p.payment_state='T' and sales_state='F' and (((rm.room_type='desk') or (rm.room_type like 'meeting%')) and p.backoffice_no=?1 and trunc(payment_date) between trunc(current_date) - interval '14' day and trunc(current_date) - interval '7' day) ) +  "
			...
			+ "(select NVL(sum(payment_total),0) as sales_total from paymentinfo p left outer join roominfo rm on p.room_no=rm.room_no where rm.room_type='office' and p.backoffice_no=?1 and payment_state='T' and sales_state='F' and trunc(payment_date) between trunc(current_date) - interval '14' day and trunc(current_date) - interval '7' day ) ) pre_sales_total from dual) as pre_sales_total,  "
	...
	@Query(nativeQuery = true, value = "select  "
			+ "(select ( "
			+ "(select NVL(sum(p.payment_total),0) as sales_total from paymentinfo p, roominfo rm where p.room_no=rm.room_no and p.payment_state='T' and sales_state='F' and (((rm.room_type='desk') or (rm.room_type like 'meeting%')) and p.backoffice_no=?1  and trunc(payment_date) between add_months(trunc(current_date),-1) and trunc(current_date) )) +  "
			...
			+ "(select NVL(sum(payment_total),0) as sales_total from paymentinfo p, roominfo rm where p.room_no=rm.room_no and rm.room_type='office' and p.backoffice_no=?1 and payment_state='T' and sales_state='F' and trunc(payment_date) between add_months(trunc(current_date),-1) and trunc(current_date)) ) sales_total from dual) as sales_total,  "
			...
			+ "(select ( "
			+ "(select NVL(sum(p.payment_total),0) as sales_total from paymentinfo p left outer join roominfo rm on p.room_no=rm.room_no where p.payment_state='T' and sales_state='F' and (((rm.room_type='desk') or (rm.room_type like 'meeting%')) and p.backoffice_no=?1 and trunc(payment_date) between add_months(trunc(current_date),-2) and add_months(trunc(current_date),-1)) ) +  "
			...
			+ "(select NVL(sum(payment_total),0) as sales_total from paymentinfo p left outer join roominfo rm on p.room_no=rm.room_no where rm.room_type='office' and p.backoffice_no=?1 and payment_state='T' and sales_state='F' and trunc(payment_date) between add_months(trunc(current_date),-2) and add_months(trunc(current_date),-1) ) ) pre_sales_total from dual) as pre_sales_total,  "
