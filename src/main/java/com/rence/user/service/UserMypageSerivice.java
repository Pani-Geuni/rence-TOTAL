...
public interface UserMypageSerivice {
	...
	//미이페이지 - 프로필 수정
	 Map<String, String> user_img_updateOK(UserDto udto, HttpServletRequest request, MultipartHttpServletRequest mtfRequest, MultipartFile multipartFile_user, HttpServletResponse response);
