              ...
              if (res.cnt > 0) {
                ...
                for (let i = 0; i < res.cnt; i++) {
                  ...
                  if (res.sc_vos[i].reserve_is === 'X') {
                    body_row.find('.reserve_is').append('<img src="@/assets/IMG/dash-board/ico-close.svg" />');
                  } else {
                    body_row.find('.reserve_is').append('<img src="@/assets/IMG/dash-board/ico-circle.svg" />');
                  }
        ...
        $.ajax({
          ...
          success(res) {
            ...
            for (let i = 0; i < res.cnt; i++) {
              ...
              if (res.sc_vos[i].reserve_is === 'X') {
                row.find('.reserve_is').append('<img src="@/assets/IMG/dash-board/ico-close.svg" />');
              } else {
                row.find('.reserve_is').append('<img src="@/assets/IMG/dash-board/ico-circle.svg" />');
              }
