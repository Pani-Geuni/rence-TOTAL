...
$(function () {
  ...
  if ($('#backoffice_info').val() != null) {
    const len = $('#backoffice_info').val().length;
  ...
  const temp_tag = $('#real-input-tag').val();
  ...
  $('#submit').on('click', () => {
    ...
    } else if ($('#backoffice_info').val().trim().length == 0) {
